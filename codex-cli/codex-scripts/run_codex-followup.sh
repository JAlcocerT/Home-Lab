...
PROMPT_FILE="./prompt-init-userguide-followup.md" # Path to your markdown prompt file
...
# --- Read content of the prompt file written in markdown ---
...
echo "Inner container command: bash -c \"cd /app/project && $CODEX_COMMAND\""

docker exec -t $DOCKER_ENV_VARS "$CONTAINER_NAME" bash -c "cd /app/project && $CODEX_COMMAND"
