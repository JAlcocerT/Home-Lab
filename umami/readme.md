...
1. For me, the setup of [**Umami** for Web Analytics](https://fossengineer.com/selfhosting-umami-with-docker/) is one of those homelab essentials.
...
There are few other web analytics options available:
